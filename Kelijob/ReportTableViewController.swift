...
class ReportTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let rightBarButtonItem: UIBarButtonItem = UIBarButtonItem(title: "作成", style: .plain, target: self, action: #selector(self.barButtonTapped(sender:)))
        self.navigationItem.setRightBarButton(rightBarButtonItem, animated: true)
    }
    
    func barButtonTapped(sender:UIBarButtonItem){
        performSegue(withIdentifier: "ProfileShowCreateReport", sender: self)
    }
